          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                >
                  {translate('Start Your Journey', language)}
              ...
              {[
                {
                  ...
                  desc: "AI-powered scheme recommendations tailored to your profile"
                },
                {
                  icon: Shield,
                  title: "Secure & Private",
                  desc: "Your data is encrypted and protected with advanced security"
                },
                {
                  icon: Zap,
                  title: "Instant Support",
                  desc: "Get immediate Support with 24*7 chatbot  "
                }
              ].map((feature, idx) => (
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  {[
                    { title: "Create Profile", desc: "One-time setup for personalized recommendations" },
                    { title: "Get Matched", desc: "AI matches your profile with eligible schemes" },
                    { title: "Access Benefits", desc: "Direct access to your eligible government benefits" }
                  ].map((step, idx) => (
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-600 mb-12">
              Join thousands of citizens who have already discovered their eligible schemes.
            </p>
            <Link
              to="/signup"
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
              <div className="col-span-2 md:col-span-1">
                ...
                <p className="text-slate-600 text-sm">
                  Empowering citizens through simplified access to government schemes.
                </p>
              </div>
              ...
              {[
                ...
                },
                {
                  title: "Contact",
                  links: [
                    { label: "Email Us", href: "mailto:support@nitinirman.com" },
            ...
            <div className="pt-8 border-t border-slate-100">
              <p className="text-sm text-slate-600 text-center">
                © {new Date().getFullYear()} Niti-Nirman™. All rights reserved.
              </p>
            </div>
          </div>
        </div>
